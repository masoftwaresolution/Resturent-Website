...
function Contact() {
    ...
    return (
        <div>
            <div className="bg-[url('/images/contactpic.jpg')] bg-cover bg-center h-[90vh]">
                <div className="bg-black/80 h-full flex flex-col justify-center items-center text-white text-center px-6">
                    <Animation><h1 className="text-5xl md:text-6xl font-bold mb-6">Contact Us</h1></Animation>
                    <Animation><p className="max-w-3xl text-lg text-gray-300 text-left md:text-center lg:text-center">Get in touch with us to discuss your web development ideas, business goals, and creative projects. We are ready to build modern, responsive, and high-performing websites for your brand.</p></Animation>
                </div>
            </div>
            <div className="lg:flex lg:justify-center lg:items-center h-auto bg-zinc-900 pt-2 md:pt-4 lg:pt-0 px-6 md:px-12 lg:px-24 lg:gap-6">
                <Animation><form ref={form} onSubmit={sendEmail} className="bg-zinc-800 border-2 border-zinc-700 hover:border-yellow-400 hover:border-2 hover:-translate-y-2 hover:shadow-2xl transition duration-300 p-8 rounded-2xl shadow-lg lg:w-auto">
                ...
                <div className="mx-auto md:w-1/2 lg:max-w-sm md:px-auto py-10 grid lg:grid-cols-1 gap-4">
                    <Animation><div className="h-auto w-full bg-zinc-800 border-2 border-zinc-700 hover:border-yellow-400 hover:border-2 hover:-translate-y-2 hover:shadow-2xl transition duration-300 rounded-2xl">
                    ...
                    <Animation><div className="h-auto w-full px-4 bg-zinc-800 border-2 border-zinc-700 hover:border-yellow-400 hover:border-2 hover:-translate-y-2 hover:shadow-2xl transition duration-300 rounded-2xl">
                        <div className="flex justify-center mt-1">
