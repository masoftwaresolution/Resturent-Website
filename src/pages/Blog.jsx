        ...
        <div class="bg-zinc-900">
            <div className="relative h-[50vh]">
                ...
                <div className="absolute inset-0 bg-black/60 flex items-center justify-center">
                    <h1 className="text-white text-3xl md:text-5xl lg:text-5xl font-bold"> Our Blog </h1>
                </div>
            </div>
            <div className="grid gap-4 md:gap-6 lg:gap-10 md:grid-cols-2 lg:grid-cols-3 mb-8 px-6 md:px-12 lg:px-24 pt-2 md:pt-6 lg:pt-12">
                <div className="bg-white rounded-2xl shadow-md hover:shadow-xl transition duration-300 overflow-hidden group">
                    ...
                    <div className="p-6">
                        ...
                        <p className="text-gray-500 mb-4"> Discover the most delicious Italian dishes that will tantalize your taste buds... </p>
