        ...
        <div>
            <div className="relative ">
                ...
                <div className="absolute inset-0 flex flex-col justify-center px-6 md:px-12 lg:px-24 ">
                    ...
                    <Link to="/Contact" className="bg-yellow-400 hover:bg-yellow-600 rounded-2xl h-12 w-32 md:mx-auto lg:mx-auto flex items-center justify-center text-black font-semibold mt-1 md:mt-4 lg:mt-4 transition duration-300">Contact Us</Link>
                </div>
            </div >
            <div className="bg-zinc-900 px-6 md:px-12 lg:px-24">
                <h1 className="text-center text-4xl font-semibold text-white pt-6">About Us </h1>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-8 gap-6 md:gap-8 lg:gap-10 pb-8">
                    ...
                    <div className="h-auto w-auto bg-white flex justify-center items-center flex-col text-center pt-8 rounded-2xl">
                        ...
                        <h1 className="text-4xl text-black text-center">Traditional <br /> & Modern</h1>
                        <p className="text-gray-400 text-center">Discover the passion, flavors, and creativity <br /> that go into every plate.</p>
                        <button className="bg-orange-500 hover:bg-orange-600 mb-10 text-3xl sm:text-2xl text-white px-2 rounded-2xl h-12 mt-4 block m-auto">Reserve Table</button>
                    </div>
                    <div className="h-auto w-auto bg-gray-500  rounded-3xl">
